...
def get_similar_question(question):
    ...
    similar = {'close1': str(data_questions.iloc[main_array[i][0]]).split('\n')[0].split('    ')[1],
    'close2': str(data_questions.iloc[main_array[i][1]]).split('\n')[0].split('    ')[1],
    'close3': str(data_questions.iloc[main_array[i][2]]).split('\n')[0].split('    ')[1]
    }
